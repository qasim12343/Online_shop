...
class User{
  ...
  Map toJson(){
      List<Map>? purchases =
      this.purchases != null? this.purchases!.map((e) => e.toJson()).toList(): null;
      List<Map>? favorites =
      this.favorites != null? this.favorites!.map((e) => e.toJson()).toList(): null;
      List<Map>? myProducts =
      this.myProducts != null? this.myProducts!.map((e) => e.toJson()).toList(): null;
      return{
        'firstName':firstName,
        'lastName':lastName,
        'password': password,
